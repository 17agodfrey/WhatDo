        ...
        private void SeedDatabase(IServiceProvider serviceProvider)
        {
            using (var scope = serviceProvider.CreateScope())
            {
                ...
                var dates = new List<Date>
                {
                    ...
                    new Date { Id = Guid.NewGuid(), Name = "boxing class", Description = null, Duration = "1.5", Price = null, Rating = null, ActivityLevel = ActivityLevel.High, IndoorOutdoor = IndoorOutdoor.Indoor },
                    new Date { Id = Guid.NewGuid(), Name = "dance class", Description = null, Duration = "1.5", Price = null, Rating = null, ActivityLevel = ActivityLevel.High, IndoorOutdoor = IndoorOutdoor.Indoor },
                    new Date { Id = Guid.NewGuid(), Name = "swing dancing", Description = null, Duration = "2", Price = null, Rating = null, ActivityLevel = ActivityLevel.High, IndoorOutdoor = IndoorOutdoor.Indoor },
                    new Date { Id = Guid.NewGuid(), Name = "cooking class", Description = null, Duration = "2", Price = null, Rating = null, ActivityLevel = ActivityLevel.High, IndoorOutdoor = IndoorOutdoor.Indoor },
                    new Date { Id = Guid.NewGuid(), Name = "aquarium", Description = null, Duration = "2", Price = null, Rating = null, ActivityLevel = ActivityLevel.Low, IndoorOutdoor = IndoorOutdoor.Indoor },
                    new Date { Id = Guid.NewGuid(), Name = "thrift", Description = null, Duration = "1.5", Price = null, Rating = null, ActivityLevel = ActivityLevel.Low, IndoorOutdoor = IndoorOutdoor.Indoor },
                    new Date { Id = Guid.NewGuid(), Name = "roller skating", Description = null, Duration = "1.5", Price = null, Rating = null, ActivityLevel = ActivityLevel.High, IndoorOutdoor = IndoorOutdoor.Indoor },
                    new Date { Id = Guid.NewGuid(), Name = "karaoke", Description = null, Duration = "2", Price = null, Rating = null, ActivityLevel = ActivityLevel.Low, IndoorOutdoor = IndoorOutdoor.Indoor },
                    new Date { Id = Guid.NewGuid(), Name = "nickelcade", Description = null, Duration = "1.5", Price = null, Rating = null, ActivityLevel = ActivityLevel.Low, IndoorOutdoor = IndoorOutdoor.Indoor },
                    new Date { Id = Guid.NewGuid(), Name = "swimming", Description = null, Duration = "1.5", Price = null, Rating = null, ActivityLevel = ActivityLevel.High, IndoorOutdoor = IndoorOutdoor.Both },
                    new Date { Id = Guid.NewGuid(), Name = "skiing", Description = null, Duration = "5", Price = null, Rating = null, ActivityLevel = ActivityLevel.High, IndoorOutdoor = IndoorOutdoor.Outdoor },
                    new Date { Id = Guid.NewGuid(), Name = "tubing hill", Description = null, Duration = "2", Price = null, Rating = null, ActivityLevel = ActivityLevel.High, IndoorOutdoor = IndoorOutdoor.Outdoor }
                };
