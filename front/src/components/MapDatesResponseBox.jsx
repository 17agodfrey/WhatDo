...
const MapDatesResponseBox = forwardRef(({ mapResult, isSelected, onBoxClick, onImageClick }, ref) => {
    ...
    return (
        <div 
            ...
            onClick={onBoxClick}
        >
            <img src={image} alt="date image" onClick={onImageClick} style={{cursor: "pointer"}}/>
